...
Rebuild the visible UI of https://example.com/ inside formal-clone. Use mock data for private, authenticated, payment, database, or backend behavior. Do not call or reproduce private backend systems.
